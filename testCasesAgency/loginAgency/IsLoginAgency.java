...
public class IsLoginAgency {
	...
	public void chkDivError(){
		...
		try {
			...
			Assert.assertEquals(useraccountNUllchk.getText(), "* �˴����ɿհ�");
		} catch (Exception e) {
		...
		try {
			...
			Assert.assertEquals(userpasswordNUllchk.getText(), "* �˴����ɿհ�");
		} catch (Exception e) {
		System.out.println(e);	// TODO: handle exception
		}
	}
	...
	public void chkResetPwd(){
		...
		try {
			...
			Assert.assertEquals(reuseraccounterrorstring.getText(),"�û��������ڣ�");
		} catch (Exception e) {
		...
		try {
			...
			Assert.assertEquals(reuserpwderrorstring.getText(),"�������Ϊ6λ");
		} catch (Exception e) {
			Assert.assertFalse(false);// TODO: handle exception
		}
		...
		try {
			...
			Assert.assertEquals(reuserMSGerrorstring.getText(),"�����������벻һ��");
		} catch (Exception e) {
			Assert.assertFalse(false);// TODO: handle exception
		}
